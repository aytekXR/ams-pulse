...
-- Embedded copy of contracts/db/meta/postgres/0002_anomaly_alert_rule.sql.
-- Sync command: cp contracts/db/meta/postgres/0002_anomaly_alert_rule.sql server/internal/store/meta/sql/postgres_0002_anomaly_alert_rule.sql
