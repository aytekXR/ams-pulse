...
## ▶ START HERE (next session — v0.4.1 IS MERGED, TAGGED and RELEASED to GHCR; the ONLY thing left before listing is the operator's GHCR public flip — then run the clean-room verify)
