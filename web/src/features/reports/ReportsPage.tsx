 ...
 * Tenants CRUD (pattern/tag mapping with live preview).
 * White-label header config.
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {isGated ? (
        ...
        <>
          ...
          {error && <ErrorBanner message={error} onRetry={tab === "usage" ? loadUsage : loadSchedules} />}
