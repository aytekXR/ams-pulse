...
- **Pulse v0.4.2 is released and publicly installable.** The image is published and public on GHCR
  (`ghcr.io/aytekxr/ams-pulse:0.4.2`, multi-arch, cosign-signed); a one-command Docker Compose
