...
| 3 | Live ops (0:30–0:50) | Back on the dashboard: hover a stream row, open stream detail; point at viewers/publishers/CPU cards | "Every stream, viewer and node, live within ten seconds — straight from the Ant Media REST API, no sampling." |
