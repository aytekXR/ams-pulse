...
| AMS trial license lapsed 2026-07-12T12:09Z | `local_env.ams_trial_license_expiry` | Operator-waived; observe and report only. **S29/D-091 update:** SRT ingest (TC-I-05-SRT) license-blocked (SRTAdaptor "License is suspended", evidence `S29-TC-I-05-SRT-20260713T215932Z/`). **S30/D-092 update:** post-restart enforcement extended to RTMP (evidence `S30-rtmp-license-block-20260713T2353Z/`); new license applied + restart; RTMP RESTORED. Enforcement model: lapse alone spares running streams; restart under lapsed license kills ALL new ingest; recovery = key + restart. **S31/D-093 update (2026-07-14T02:29:45Z):** TC-I-05-SRT PASS (2/2 assertions) — first live SRT run; evidence `TC-I-05-SRT-20260714T022945Z/`. **Blocked-scenario list: EMPTY.** |
