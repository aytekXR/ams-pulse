...
| AMS trial license lapsed 2026-07-12T12:09Z | `local_env.ams_trial_license_expiry` | Operator-waived; observe and report only. **S29/D-091 update:** blocked-scenario-list is no longer EMPTY. SRT ingest (TC-I-05-SRT) is license-blocked: SRTAdaptor "License is suspended" observed live 2026-07-13 (evidence: `qa/realams/evidence/S29-TC-I-05-SRT-20260713T215932Z/`). **S30/D-092 update:** the first post-lapse AMS restart (2026-07-13 22:21Z, crash + auto-restart) extended enforcement to RTMP: all new publishes refused ("License is suspended and not accepting connection"; evidence `qa/realams/evidence/S30-rtmp-license-block-20260713T2353Z/`). The teststream CANNOT be restarted until the license lands. Blocked=[SRT ingest, RTMP ingest (new connections), any scenario needing a fresh publish]. |
