...
| 5 | Bug Investigation | ROLLING (BUG-001..010 filed; **003/004 FIXED S20, 005 FIXED S21, 006/007/010 FIXED S22, 008/009 PARTIALLY FIXED S22** — declared-param violations 27→4, all pinned by `param_conformance_test.go` (35 probes): 008 from/to → S23 flag-event-store design (`BUG-008-triage-s22.md`), 009 tenant ×2 → F6 multi-tenancy; 001 low / **002 design-note ready = S23 primary**) | S17+ | Any |
