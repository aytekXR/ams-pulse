...
ERROR: The Pulse container image is not accessible from the registry.
  Image : ghcr.io/aytekxr/ams-pulse:0.4.2
```
...
(tags have **no `v` prefix** — `0.4.2`, not `v0.4.2`) and retry
`docker pull ghcr.io/aytekxr/ams-pulse:0.4.2`. If your environment cannot reach
